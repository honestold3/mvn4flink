 ...
 *
 * <p>
 * When using the first constructor {@link Map, IndexRequestBuilder)}
 * the sink will create a local {@link Node} for communicating with the
 * Elasticsearch cluster. When using the second constructor
 * {@link(Map, List, IndexRequestBuilder)} a {@link TransportClient} will
 * be used instead.
 *
 * <p>
 ...
 */
public class ElasticsearchSink11<T> extends RichSinkFunction<T> {
	...
	public static final Logger LOG = LoggerFactory.getLogger(org.apache.flink.streaming.connectors.elasticsearch.ElasticsearchSink.class);

	/**
	 * The user specified config map that we forward to Elasticsearch when we create the Client.
	 */
	public final Map<String, String> userConfig;
	 ...
	 */
	public final List<TransportAddress> transportNodes;

	/**
	 * The builder that is used to construct an {@link IndexRequest} from the incoming element.
	 */
	public final IndexRequestBuilder<T> indexRequestBuilder;
	 ...
	 */
//	public ElasticsearchSink11(Map<String, String> userConfig, IndexRequestBuilder<T> indexRequestBuilder) {
...
//	}
	 ...
	 *
	 */
	public ElasticsearchSink11(Map<String, String> userConfig, List<TransportAddress> transportNodes, IndexRequestBuilder<T> indexRequestBuilder) {
		this.userConfig = userConfig;
		this.indexRequestBuilder = indexRequestBuilder;
	 ...
	 * {@link Node} and retrieving the
	 * {@link Client} from it or by creating a
