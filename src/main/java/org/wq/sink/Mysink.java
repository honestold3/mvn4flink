...
public class Mysink<T>
     ...
     */
    public Mysink<T> setFSConfig(Configuration config) {
     ...
     * the {@link FileSystem} for writing.
     */
    public Mysink<T> setFSConfig(org.apache.hadoop.conf.Configuration config) {
        this.fsConfig = new Configuration();
    ...
    public void invoke(T value) throws Exception {
        ...
        //String k = tuple.f0;
        //String v = tuple.f1;
        //Path bucketPath = new Path(basePath+"/"+k);

        scala.Tuple2 tu = (scala.Tuple2<String,String>)value;
        String k1 = (String)tu._1;
        String v1= (String)tu._2;
        Path bucketPath = new Path(basePath+"/"+k1);
...
//                getClass().getSimpleName(), getRuntimeContext().getIndexOfThisSubtask(), state);
     ...
     */
    public Mysink<T> setBatchSize(long batchSize) {
     ...
     */
    public Mysink<T> setInactiveBucketCheckInterval(long interval) {
     ...
     */
    public Mysink<T> setInactiveBucketThreshold(long threshold) {
     ...
     */
    public Mysink<T> setBucketer(Bucketer<T> bucketer) {
     ...
     */
    public Mysink<T> setWriter(Writer<T> writer) {
     ...
     */
    public Mysink<T> setInProgressSuffix(String inProgressSuffix) {
     ...
     */
    public Mysink<T> setInProgressPrefix(String inProgressPrefix) {
     ...
     */
    public Mysink<T> setPendingSuffix(String pendingSuffix) {
     ...
     */
    public Mysink<T> setPendingPrefix(String pendingPrefix) {
     ...
     */
    public Mysink<T> setValidLengthSuffix(String validLengthSuffix) {
     ...
     */
    public Mysink<T> setValidLengthPrefix(String validLengthPrefix) {
     ...
     */
    public Mysink<T> setPartPrefix(String partPrefix) {
     ...
     */
    @Deprecated
    public Mysink<T> disableCleanupOnOpen() {
        return this;
    }
     ...
     */
    public Mysink<T> setAsyncTimeout(long timeout) {
